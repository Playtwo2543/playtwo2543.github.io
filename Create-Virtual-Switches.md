...
## ภาคผนวก ศัพท์
  ...
  9. Internal Network : รูปแบบเครือข่ายที่เชื่อมต่อเฉพาะ Host และ VM ภายในเครื่องเดียวกัน
  
  10. Private Network : เครือข่ายที่จำกัดการเชื่อมต่อเฉพาะ VM เท่านั้น ไม่มีการเชื่อมต่อกับ Host หรือภายนอก
  
  11. Create Virtual Switch : คำสั่งสำหรับเริ่มต้นสร้าง Virtual Switch ใหม่ในระบบ Hyper-V
  
  12. Apply / OK : คำสั่งยืนยันและบันทึกค่าการตั้งค่า Virtual Switch
